...
import com.slife.controller.MainController;
...
public class SysMetaObjectHandler extends MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        if (null == createId) {
            metaObject.setValue("createId", mainController.getShiroUser().getId());
        }
        if (null == updateDate) {
            metaObject.setValue("updateDate", new Date());
        }
        if (null == updateId) {
            metaObject.setValue("updateId", mainController.getShiroUser().getId());
        }
    }
